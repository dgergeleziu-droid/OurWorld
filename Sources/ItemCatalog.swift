...
struct CatalogItem: Identifiable, Hashable {
    ...
    let name: String
    let emoji: String
    let imageName: String?   // имя PNG без расширения (nil = использовать emoji)
    let size: CGFloat
...
enum ItemCatalog {
    static let all: [CatalogItem] = [
        ...
        CatalogItem(id: "mirror", name: "Зеркало", emoji: "🪞", imageName: "bathroomMirror", size: 55, category: .furniture),
        ...
        CatalogItem(id: "computer", name: "Компьютер", emoji: "💻", imageName: "computerScreen", size: 55, category: .furniture),
        ...
        CatalogItem(id: "bear", name: "Мишка", emoji: "🧸", imageName: "bear", size: 55, category: .furniture),
        CatalogItem(id: "ceilingFan", name: "Вентилятор", emoji: "🌀", imageName: "ceilingFan", size: 55, category: .furniture),
        CatalogItem(id: "coatRack", name: "Вешалка", emoji: "🧥", imageName: "coatRackStanding", size: 65, category: .furniture),
        CatalogItem(id: "stool", name: "Табурет", emoji: "🪑", imageName: "stoolBar", size: 50, category: .furniture),
        ...
        CatalogItem(id: "birthdayCake", name: "Праздничный торт", emoji: "🎂", imageName: "cake-birthday", size: 60, category: .food),
        ...
        CatalogItem(id: "icecreamChoc", name: "Шок. мороженое", emoji: "🍫", imageName: "ice-cream-scoop-chocolate", size: 45, category: .food),
        ...
        CatalogItem(id: "burgerDouble", name: "Двойной бургер", emoji: "🍔", imageName: "burger-double", size: 55, category: .food),
        ...
        CatalogItem(id: "bread", name: "Хлеб", emoji: "🍞", imageName: "bread", size: 50, category: .food),
        ...
        CatalogItem(id: "cocktail", name: "Коктейль", emoji: "🍹", imageName: "cocktail", size: 45, category: .food),
        CatalogItem(id: "candy", name: "Конфета", emoji: "🍬", imageName: "candy-bar", size: 35, category: .food),
        CatalogItem(id: "chocolate", name: "Шоколад", emoji: "🍫", imageName: "chocolate", size: 40, category: .food),
        CatalogItem(id: "cookie", name: "Печенье", emoji: "🍪", imageName: "cookie", size: 40, category: .food),
        ...
        CatalogItem(id: "gift", name: "Подарок", emoji: "🎁", imageName: "cardBoardBoxClosed", size: 50, category: .decor),
        ...
        CatalogItem(id: "pyramid", name: "Пирамида", emoji: "🔺", imageName: "pyramid", size: 90, category: .nature),

        // ========== ИГРУШКИ (нет картинок — оставляем emoji) ==========
